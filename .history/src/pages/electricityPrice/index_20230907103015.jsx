...
import { getFirstArea, getSecondArea, getElectricType } from '@/services/area';
...
const ElectricityPrice = (props) => {
    ...
    const initElectricType = async (pId) => {
        let res = await getElectricType(pId)
        if (res?.code == 200) {
            setSelector({
                ...selector,
